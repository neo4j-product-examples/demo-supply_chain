...
After downloading, place it in the `data/` directory and can be used to import the data to your database. Refer http://localhost:8000/developer/demos/supply_chain-demo/#setup for instructions 
